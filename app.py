...
if not df.empty:
    ...
    if not valid_df.empty:
        ...
        # ==========================================
        # 📋 ПОЛНАЯ ТАБЛИЦА С ЦВЕТОВОЙ ИНДИКАЦИЕЙ
        # ==========================================
        st.markdown("---")
        ...
        # 4. Переименовываем и выстраиваем в логичном порядке
        display_df.columns = [
        ...
        # vmin=0, vmax=100 гарантирует, что цвета будут корректны для процентов
